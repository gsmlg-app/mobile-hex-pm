...
void main() {
  ...
  group('FieldBloc:', () {
    ...
    group('constructor:', () {
      ...
      test(
        'validators verify the value and add the corresponding error.',
        () async {
          ...
          expectBloc(
            ...
            stream: [state2, state3, state4, state5],
          );
        },
      );

      test(
        'asyncValidators verify the value and add the corresponding error.',
        () async {
          final fieldBloc = InputFieldBloc<int?, dynamic>(
            name: 'fieldName',
            initialValue: null,
      ...
      test(
        '_suggestions is added to suggestions of the current state.',
        () async {
          ...
          expect(fieldBloc.state, expectedStates.first);

          expect(await fieldBloc.state.suggestions?.call(''), [1, 2, 3]);
        },
      );
      test('_name is added to the current state', () async {
        ...
        expect('fieldName', fieldBloc.state.name);
      });
    });
    ...
    test('changeValue.', () async {
      ...
      await expectBloc(
        ...
        stream: [state = state.copyWith(value: Param(2), error: Param(null))],
      );
    });
    ...
    test('updateValue method.', () {
      ...
      final expectedStates = [state2, state3, state4];
    ...
    test('updateValue method with isRequired false', () {
      ...
      final state2 = state1.copyWith(updatedValue: Param(1), value: Param(1));
      final state3 = state2.copyWith(
        updatedValue: Param(null),
        value: Param(null),
      );
      final state4 = state3.copyWith(updatedValue: Param(2), value: Param(2));
    ...
    test('updateInitialValue.', () {
      ...
      expectBloc(fieldBloc, stream: [state2, state3, state4, state5]);
    ...
    test('clear method set value to initialValue.', () async {
      ...
      final expectedStates = [state1, state2];
    ...
    test(
      ...
      () {
        ...
        expect(fieldBloc.selectedSuggestion, emitsInOrder(expectedSuggestions));
    ...
    group('addValidators', () {
      test('add validators and emit error', () async {
        ...
        final state2 = state1.copyWith(error: Param('1 error'));
        final state3 = state2.copyWith(
          updatedValue: Param(null),
          value: Param(null),
          error: Param(FieldBlocValidatorsErrors.required),
    ...
    test('updateValidators.', () {
      ...
      final state3 = state2.copyWith(error: Param('2 error'));
      final state4 = state3.copyWith(
        updatedValue: Param(1),
        value: Param(1),
        error: Param(null),
    ...
    test('updateAsyncValidators method.', () async {
      final fieldBloc = InputFieldBloc<int?, dynamic>(
        ...
        validators: [FieldBlocValidators.required],
        asyncValidators: [(value) async => value == 1 ? '1 error' : null],
      );
      ...
      final state4 = state3.copyWith(isValidated: true, isValidating: false);
      final state5 = state4.copyWith(isValidated: false, isValidating: true);
    ...
    group('removeValidators', () {
      test('remove validators and not emit error', () async {
        ...
        final state3 = state2.copyWith(error: Param(null), isValidated: true);
    ...
    test('updateSuggestions method.', () {
      ...
      final state2 = state1.copyWith(suggestions: Param(suggestions2));
      final state3 = state2.copyWith(suggestions: Param(null));
    ...
    test(
      ...
      () async {
        final fieldBloc = InputFieldBloc<int?, dynamic>(
          ...
          asyncValidators: [(value) async => value == 2 ? 'async == 2' : null],
        );
        ...
        final state3 = state2.copyWith(updatedValue: Param(1), value: Param(1));
        final state4 = state3.copyWith(isValueChanged: true, value: Param(3));
        final state5 = state4.copyWith(
          isValueChanged: false,
          updatedValue: Param(6),
          value: Param(6),
        ...
        final state7 = state6.copyWith(updatedValue: Param(2), value: Param(2));
    ...
    test('ResetFieldBlocStateIsValidated event.', () {
      ...
      final state2 = state1.copyWith(isValidated: false);
    ...
    test('UpdateFieldBlocStateError event.', () {
      ...
      final state2 = state1.copyWith(error: Param('error2'));
    ...
    test(
      'on subscribeToFieldBlocs method and SubscribeToFieldBlocs event.',
      () async {
        ...
        final state2 = state1.copyWith(error: Param(equalError));

        final state3 = state2.copyWith(updatedValue: Param(2), value: Param(2));

        final state4 = state3.copyWith(error: Param(null));
        ...
        final state6 = state5.copyWith(error: Param(null));
        ...
        expectBloc(fieldBloc1, stream: expectedStates);
    ...
    group('addError', () {
      test('addError method and with isPermanent false.', () async {
        ...
        expectBloc(fieldBloc, stream: [state2, state3, state4]);
      ...
      test('addError method and with isPermanent true.', () async {
        ...
        final state2 = state1.copyWith(error: Param('error'), isDirty: true);
        ...
        expectBloc(fieldBloc, stream: [state2, state4, state5]);
      ...
      test(
        'addError method isPermanent false after disable auto validation.',
        () async {
          final fieldBloc = InputFieldBloc<int?, dynamic>(
            name: 'fieldName',
            initialValue: null,
    ...
    test('If extraData is null, extraData in state is null', () async {
      ...
      expect(fieldBloc.state.extraData, null);
    });
