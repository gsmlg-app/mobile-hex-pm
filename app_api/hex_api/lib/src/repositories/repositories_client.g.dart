...
part of 'repositories_client.dart';
...
class _RepositoriesClient implements RepositoriesClient {
  _RepositoriesClient(this._dio, {this.baseUrl, this.errorLogger});
  ...
  @override
  Future<Repository> getRepo({required String name}) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
