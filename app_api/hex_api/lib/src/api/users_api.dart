...
class UsersApi {
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [UserWithOrgs] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<UserWithOrgs>> getCurrentUser({
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    UserWithOrgs? _responseData;

    try {
      final rawData = _response.data;
      _responseData = rawData == null
          ? null
          : deserialize<UserWithOrgs, UserWithOrgs>(rawData, 'UserWithOrgs',
              growable: true);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
  ...
  Future<Response<User>> getUser({
    ...
    final _path = r'/users/{username_or_email}'
        .replaceAll('{' r'username_or_email' '}', usernameOrEmail.toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> resetUserPassword({
    required String usernameOrEmail,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/users/{username_or_email}/reset'
        .replaceAll('{' r'username_or_email' '}', usernameOrEmail.toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
