...
class _PackagesClient implements PackagesClient {
  ...
  Future<List<Package>> listPackages({
    ...
    final _options = _setStreamType<List<Package>>(
  ...
  @override
  Future<Package> getPackage({required String name}) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<Package>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/packages/${name}',
    ...
    late Package _value;
    try {
      _value = Package.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
